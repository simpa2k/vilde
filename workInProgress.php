    ...
    <body id="body">
        ...
        <div id="main">
            <div id="header">
                ...
                <h1 class="heading">Aj, aj, aj!</h1>
            </div>
        
            <div class="section" id="shows">
                <h1 class="section-heading">Vi ber om ursäkt</h1>
                    <p class="section-text">
                        Spöket i kökets hemsida är inte riktigt färdig än, men håll ut! Tills vidare kan ni besöka vår facebooksida på <a href="https://www.facebook.com/spoketikoket">www.facebook.com/spoketikoket</a>. På återseende!
                    </p>
            </div>
